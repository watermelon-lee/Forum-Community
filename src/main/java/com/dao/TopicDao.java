...
public class TopicDao extends BaseDao<Topic> {
    ...
    private static final String QUERY_TOPIC_BY_TITLE="from Topic where topicTitle like ? order by lastPost";
    ...
    public Page queryTopicByTitle(int pageSize,int pageNo,String title){
        return searchQuery(QUERY_TOPIC_BY_TITLE,pageNo,pageSize,title);
    }
